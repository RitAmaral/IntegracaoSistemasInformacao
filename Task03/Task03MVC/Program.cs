    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            */
            ...
            {
                //med22.SetPassword(1); //isto está comentado porque não está a funcionar / a password não está a ser alterada.
                //med22.Login(1); //isto foi usado para tentar colocar a nova password, no entanto diz sempre login errado, por isso o método SetPassword não está a funcionar.
                med22.Logout(1);
            }
