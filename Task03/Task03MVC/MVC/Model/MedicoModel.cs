...
namespace Task03MVC.MVC.Model
{
    internal class MedicoModel : ColaboradorModel //Model/Modelo; MedicoModel herda de ColaboradorModel
    {
        ...
        */ //estas propriedades são herdadas da classe ColaboradorModel, por isso não precisam de estar aqui, e estão comentadas.
        ...
        public string GetPrivatePassword() //este método foi criado aqui para podermos obter a password nas outras classes. Se não, não conseguiamos aceder à password.
        {
            return _password;
        }
        public void SetPrivatePassword(string novaPassword) //mesma explicação do método GetPrivatePassword().
        {
            _password = novaPassword;
        }
        //Método
