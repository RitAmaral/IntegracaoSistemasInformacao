...
namespace Task03MVC.MVC.View
{
    ...
    {
        public void EscreverDetalhesMedico(string funcao, int id, string nome, string genero, string localidade, DateOnly dataNasc, bool cartaConducao, double vencimento, int cc, int nif, int telemovel, string email, string nomeUtil, string _password)
        {
        ...
        public void MensagemGetPassword(string nome, string _password)
        {
            Console.WriteLine($"{nome} a tua password é: {_password}"); //mensagem que vai aparecer ao usar o método GetPassword.
            Console.WriteLine();
        }
        public void MensagemSetPassword(string novaPassword)
        {
            Console.WriteLine($"Password alterada para: {novaPassword}"); //mensagem que vai aparecer ao usar o método SetPassword.
        }
