...
namespace Agenda_DAL
{
    public class Compromisso_DAO
    {
        ...
        public bool ExisteCompromisso(string nomeCliente, out Compromisso? obj) //passou de existe cliente para existe compromisso
        {
            obj = null;
            string tNome = nomeCliente.Trim();
        ...
        { //foi feita aqui uma alteração, App.Context
