...
namespace Eurovisao_BL
{
    public class Eurovisao_BR
    {
        ...
        public bool ModificarPontosJuri(int id, int pontosJuri) //modifica pontos de juri
        {
            return _eurovisaoDAO.ModificarPontosJuri(id, pontosJuri); //nota, gostava que este método e o de baixo fossem ModificarPontos, mas dá erro..
        }
        public bool ModificarPontosTelevoto(int id, int pontosTelevoto) //modifica pontos de televoto
        {
            return _eurovisaoDAO.ModificarPontosTelevoto(id, pontosTelevoto);
        }
        /*
