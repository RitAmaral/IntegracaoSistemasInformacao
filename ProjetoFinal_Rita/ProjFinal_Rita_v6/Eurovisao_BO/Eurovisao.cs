...
namespace Eurovisao_BO
{
    ...
    public struct RegistoConcorrente
    {
        ...
        {
            return $"{ID}\t|{Pais}\t|{NomeRepresentante}\t|{NomeMusica}\t|{PontosJuri}\t|{PontosTelevoto}\t|{TotalPontos}";
        }
    }
    ...
    public class Eurovisao
    {
        ...
        // Construtores
        public Eurovisao(string pais, string nomeRepresentante, string nomeMusica, int pontosJuri, int pontosTelevoto)
        {
