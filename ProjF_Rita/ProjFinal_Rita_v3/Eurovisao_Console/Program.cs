    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            if (gestaoEurovisao.ExisteConcorrente(conc1.ID))
            {
                ...
                var registoConc1 = conc1.RegistoConcorrentes(); // converter de Eurovisao para RegistoConcorrente, se não, dá erro
                registoConc1.PontosJuri = 15; // modificar os pontos do juri conc1 para 15
                gestaoEurovisao.ModificarPontosJuri(340, 15, registoConc1); //----------------------------- Não funciona--------------
                MostrarLista(gestaoEurovisao.GetConcorrentesList());
            }
            else
            {
            ...
            if (gestaoEurovisao.ExisteConcorrente(conc1.ID))
            {
                ...
                var registoConc1 = conc1.RegistoConcorrentes(); // converter de Eurovisao para RegistoConcorrente, se não, dá erro
                registoConc1.PontosTelevoto = 20; //quero mudar os pontos televoto para 20
                gestaoEurovisao.ModificarPontosTelevoto(243, 20, registoConc1); //----------------------------- Não funciona------------
                MostrarLista(gestaoEurovisao.GetConcorrentesList());
            }
            else
            {
