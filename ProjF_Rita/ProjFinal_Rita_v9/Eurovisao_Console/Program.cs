...
namespace Eurovisao_Console
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Eurovisao s1f1 = gestaoEurovisao.NovoConcorrente("Finlândia", "Kaarija", "Cha Cha Cha","SemiFinal1", 0, 177);
            Eurovisao s1f2 = gestaoEurovisao.NovoConcorrente("Suécia", "Loreen", "Tattoo", "SemiFinal1", 0, 135);
            Eurovisao s1f3 = gestaoEurovisao.NovoConcorrente("Israel", "Noa Kirel", "Unicorn", "SemiFinal1", 0, 127);
            Eurovisao s1f4 = gestaoEurovisao.NovoConcorrente("Chéquia", "Vesna", "My Sister's Crown", "SemiFinal1", 0, 110);
            Eurovisao s1f5 = gestaoEurovisao.NovoConcorrente("Moldávia", "Pasha Parfeni", "Soarale si Luna", "SemiFinal1", 0, 109);
            Eurovisao s1f6 = gestaoEurovisao.NovoConcorrente("Noruega", "Alessandra", "Queen of Kings", "SemiFinal1", 0, 102);
            Eurovisao s1f7 = gestaoEurovisao.NovoConcorrente("Suiça", "Remo Forrer", "Watergun", "SemiFinal1", 0, 97);
            Eurovisao s1f8 = gestaoEurovisao.NovoConcorrente("Croácia", "Let 3", "Mama SC!", "SemiFinal1", 0, 76);
            Eurovisao s1f9 = gestaoEurovisao.NovoConcorrente("Portugal", "Mimicat", "Ai Coração", "SemiFinal1", 0, 74);
            Eurovisao s1f10 = gestaoEurovisao.NovoConcorrente("Sérvia", "Luke Black", "Samo mi se spava", "SemiFinal1", 0, 37);
            Eurovisao s1f11 = gestaoEurovisao.NovoConcorrente("Letónia", "Sudden Lights", "Aijã", "SemiFinal1", 0, 34);
            Eurovisao s1f12 = gestaoEurovisao.NovoConcorrente("Irlanda", "Wild Youth", "We Are One", "SemiFinal1", 0, 10);
            Eurovisao s1f13 = gestaoEurovisao.NovoConcorrente("Países Baixos", "Mia Nicolai & Dion Cooper", "Burning Daylight", "SemiFinal1", 0, 7);
            Eurovisao s1f14 = gestaoEurovisao.NovoConcorrente("Azerbeijão", "TuralTuranX", "Tell Me More", "SemiFinal1", 0, 4);
            Eurovisao s1f15 = gestaoEurovisao.NovoConcorrente("Malta", "The Busker", "Dance (Our Own Party)", "SemiFinal1", 0, 3);
            ...
            Console.WriteLine("----------------------------------------------------------------------------------------------------");
            MostrarLista(gestaoEurovisao.GetConcorrentesList("SemiFinal1"));
            ...
            if (gestaoEurovisao.ApagarConcRonda("SemiFinal1")) //apaga os 5 últimos concorrentes da lista
            {
                Console.WriteLine("ID\t|País\t|Representante\t|Música\t|Ronda\t|Júri\t|Televoto\t|Total Pontos");
                Console.WriteLine("----------------------------------------------------------------------------------------------------");
                MostrarLista(gestaoEurovisao.GetConcorrentesList("SemiFinal1"));
            ...
            Eurovisao s2f1 = gestaoEurovisao.NovoConcorrente("Austrália", "Voyager", "Promise", "SemiFinal2", 0, 149);
            Eurovisao s2f2 = gestaoEurovisao.NovoConcorrente("Áustria", "Teya & Salena", "Who The Hell Is Edgar?", "SemiFinal2", 0, 137);
            Eurovisao s2f3 = gestaoEurovisao.NovoConcorrente("Polónia", "Blanka", "Solo", "SemiFinal2", 0, 124);
            Eurovisao s2f4 = gestaoEurovisao.NovoConcorrente("Lituânia", "Monika Linkyté", "Stay", "SemiFinal2", 0, 110);
            Eurovisao s2f5 = gestaoEurovisao.NovoConcorrente("Eslovénia", "Joker Out", "Carpe Diem", "SemiFinal2", 0, 103);
            Eurovisao s2f6 = gestaoEurovisao.NovoConcorrente("Arménia", "Brunette", "Future Lover", "SemiFinal2", 0, 99);
            Eurovisao s2f7 = gestaoEurovisao.NovoConcorrente("Chipre", "Andrew Lambrou", "Break a Broken Heart","SemiFinal2", 0, 94);
            Eurovisao s2f8 = gestaoEurovisao.NovoConcorrente("Bélgica", "Gustaph", "Because of You", "SemiFinal2", 0, 90);
            Eurovisao s2f9 = gestaoEurovisao.NovoConcorrente("Albânia", "Albina & Familija Kelmendi", "Duje","SemiFinal2", 0, 83);
            Eurovisao s2f10 = gestaoEurovisao.NovoConcorrente("Estónia", "Alika", "Bridges", "SemiFinal2", 0, 74);
            Eurovisao s2f11 = gestaoEurovisao.NovoConcorrente("Islândia", "Diljá", "Power", "SemiFinal2", 0, 44);
            Eurovisao s2f12 = gestaoEurovisao.NovoConcorrente("Geórgia", "Iru", "Echo", "SemiFinal2", 0, 33);
            Eurovisao s2f13 = gestaoEurovisao.NovoConcorrente("Grécia", "Victor Vernicos", "What They Say", "SemiFinal2", 0, 14);
            Eurovisao s2f14 = gestaoEurovisao.NovoConcorrente("Dinamarca", "Reiley", "Breaking My Heart", "SemiFinal2", 0, 6);
            Eurovisao s2f15 = gestaoEurovisao.NovoConcorrente("Roménia", "Theodor Andrei", "D.G.T. (Off and On)", "SemiFinal2", 0, 0);
            Eurovisao s2f16 = gestaoEurovisao.NovoConcorrente("San Marino", "Piqued Jacks", "Like An Animal", "SemiFinal2", 0, 0);
            ...
            Console.WriteLine("----------------------------------------------------------------------------------------------------");
            MostrarLista(gestaoEurovisao.GetConcorrentesList("SemiFinal2"));
            ...
            if (gestaoEurovisao.ApagarConcRonda("SemiFinal2")) //apaga os 6 últimos concorrentes da lista
            {
                Console.WriteLine("ID\t|País\t|Representante\t|Música\t|Ronda\t|Júri\t|Televoto\t|Total Pontos");
                Console.WriteLine("----------------------------------------------------------------------------------------------------");
                MostrarLista(gestaoEurovisao.GetConcorrentesList("SemiFinal2"));
            ...
            Eurovisao conc4 = gestaoEurovisao.NovoConcorrente("Itália", "Marco Mengoni", "Due Vite", "Final", 176, 174);
            Eurovisao conc6 = gestaoEurovisao.NovoConcorrente("Ucrânia", "Tvorchi", "Heart of Steel", "Final", 54, 189);
            Eurovisao conc16 = gestaoEurovisao.NovoConcorrente("França", "La Zarra", "Évidemment", "Final", 54, 50);
            Eurovisao conc17 = gestaoEurovisao.NovoConcorrente("Espanha", "Blanca Paloma", "Eaea", "Final", 95, 5);
            Eurovisao conc25 = gestaoEurovisao.NovoConcorrente("Reino Unido", "Mae Muller", "I Wrote A Song", "Final", 15, 9);
            Eurovisao conc26 = gestaoEurovisao.NovoConcorrente("Alemanha", "Lord Of The Lost", "Blood & Glitter", "Final", 3, 15);
