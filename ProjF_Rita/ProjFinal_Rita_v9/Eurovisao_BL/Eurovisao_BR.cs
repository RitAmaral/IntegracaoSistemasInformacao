...
namespace Eurovisao_BL
{
    public class Eurovisao_BR : IEurovisaoMetodos //implementar a interface IEurovisaoMetodos: garante que Eurovisao_BR implemente todos os métodos definidos na interface.
    {
        ...
        //Métodos
        public Eurovisao NovoConcorrente(string pais, string nomeRepresentante, string nomeMusica, string ronda, int pontosJuri, int pontosTelevoto)
        {
        ...
        public List<string> GetConcorrentesList(string ronda) //obter lista de concorrentes por ronda
        {
